...
namespace MonkePhone.Behaviours.UI
{
    public class PhoneTextBox : PhoneUIObject
    {
        ...
        [Space] public string PlaceholderText = "Click box to open keyboard";

        public Color PlaceholderColour = new Color32(200, 200, 200, 255);

        [Space] public Text Text;
        ...
        public void OnTriggerEnter(Collider collider)
        {
            if (!collider.TryGetComponent(out GorillaTriggerColliderHandIndicator handIndicator) ||
                _lastActivation + 0.28f > Time.realtimeSinceStartup || !Phone.Held && !Phone.Leviating ||
